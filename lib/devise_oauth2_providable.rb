...
require 'devise/oauth2_providable/strategy'
require 'devise/oauth2_providable/model'
require 'devise/oauth2_providable/schema'
...
Devise.add_module(:oauth2_providable,
  :strategy => true,
  :model => 'devise/oauth2_providable/model')
